...
<mm:node referid="curnav">
	...
	<mm:related path="posrel,teasers" fields="posrel.pos" constraints="posrel.pos >0 and posrel.pos < 10 " orderby="posrel.pos">
		<div class="teasers">
	...
	<mm:related path="posrel,teasers" fields="posrel.pos" constraints="posrel.pos >9 and posrel.pos < 20 " orderby="posrel.pos">
		<div class="teasers">
		<mm:node element="teasers">
			<te:field name="title"/>
			<te:field name="subtitle"/>
	...
	<mm:related path="posrel,teasers" fields="posrel.pos" constraints="posrel.pos >19 and posrel.pos < 30 " orderby="posrel.pos">
		<div class="teasers">
		<mm:node element="teasers">
			<te:field name="title"/>
			<te:field name="subtitle"/>
